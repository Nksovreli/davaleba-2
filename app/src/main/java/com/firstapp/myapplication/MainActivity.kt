...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private var xResult: Int = 0
    private var oResult: Int = 0
    ...
    private fun check() {
        ...
        if(winnerPlayer !=0){
            if(winnerPlayer == 1) {
                xResult += 1
                result.text = "player1:${xResult.toString()}  player2:${oResult.toString()}"
    ...
    private fun reset(){
        ...
        button5.setBackgroundColor(Color.parseColor("#FF3700B3"))
        button6.setBackgroundColor(Color.parseColor("#FF3700B3"))
        button7.setBackgroundColor(Color.parseColor("#FF3700B3"))
        button8.setBackgroundColor(Color.parseColor("#FF3700B3"))
        button9.setBackgroundColor(Color.parseColor("#FF3700B3"))
        button1.text = ""
        button2.text = ""
        button3.text = ""
        button4.text = ""
